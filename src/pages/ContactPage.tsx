          ...
          <AnimatedSection animation="fade-right" delay={150}>
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div><h3 className="font-heading font-semibold mb-1">TikTok</h3><a href="https://www.tiktok.com/@nomia.se" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors">@nomia.se</a></div>
              </div>
