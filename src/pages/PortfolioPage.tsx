  ...
  const projects = [
    {
      ...
      description: t(
        'Modern webbplats med online-bokning och prislista.',
        'Modern website with online booking and price list.'
      ),
    ...
    },
    {
      ...
      description: t(
        'Stilren design med meny och öppettider.',
        'Clean design with menu and opening hours.'
      ),
    ...
    },
    {
      ...
      description: t(
        'Snabb laddning, tydliga tjänster och kontaktformulär.',
        'Fast loading, clear services, and contact form.'
      ),
    ...
    },
    {
      ...
      type: t('Gym', 'Gym'),
      description: t(
        'Energisk design med schema och medlemskap-info.',
        'Energetic design with schedule and membership info.'
      ),
    ...
    },
    {
      ...
      description: t(
        'Professionell design med tjänster och tidsbokning.',
        'Professional design with services and appointment booking.'
      ),
    ...
    },
    {
      ...
      type: t('Butik', 'Retail'),
      description: t(
        'Produktvisning med öppettider och hitta oss-karta.',
        'Product showcase with opening hours and find us map.'
      ),
      ...
      <div className="container-wide">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">
            {t(
              'Ett urval av webbplatser vi byggt för småföretag.',
              'A selection of websites we\'ve built for small businesses.'
            )}
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {projects.map((project, index) => (
            <div
              key={index}
              className="group relative bg-background border border-border rounded-lg overflow-hidden hover:border-accent transition-colors"
            >
              {/* Placeholder Image */}
              <div className="aspect-[4/3] bg-secondary flex items-center justify-center">
                <span className="text-muted-foreground text-sm">
                  {t('Förhandsvisning', 'Preview')}
                </span>
              </div>
        ...
        <div className="text-center bg-secondary/50 rounded-lg p-8">
          <h2 className="text-2xl font-bold mb-4">
            {t('Vill du se din webbplats här?', 'Want to see your website here?')}
          </h2>
