      ...
      <div className="container-wide">
        ...
        <div className="text-center mb-16 animate-fade-in">
          <h1 className="text-3xl sm:text-4xl font-bold mb-4">
            {t('Enkla, transparenta priser', 'Simple, transparent pricing')}
          </h1>
          <p className="text-muted-foreground max-w-xl mx-auto">
            {t(
              '500 kr verifieringsavgift dras av från slutpriset om du går vidare.',
              '500 kr verification fee is deducted from the final price if you proceed.'
            )}
          </p>
        </div>
        ...
        <div className="mb-20">
          <h2 className="text-2xl font-bold text-center mb-8">
            {t('Webbpaket (engångskostnad)', 'Website Packages (one-time)')}
          </h2>
        ...
        <div>
          <h2 className="text-2xl font-bold text-center mb-4">
            {t('Månatlig webbvård', 'Monthly Care Plans')}
          </h2>
          <p className="text-center text-muted-foreground mb-8 max-w-xl mx-auto">
            {t(
              'Håll din webbplats snabb, säker och uppdaterad.',
