          ...
          <div className="animate-fade-in-up">
            ...
            <div className="p-6 bg-secondary/50 rounded-lg border border-border max-w-sm mx-auto mb-8">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                {t(
                  '100% återbetalning om du inte gillar demon',
                  '100% refund if you don\'t like the demo'
                )}
              </p>
            ...
            <p className="text-sm text-muted-foreground">
              {t(
                ...
                'After payment, you\'ll receive a confirmation via email.'
              )}
            </p>
          </div>
        </div>
    ...
    <div className="section-padding py-12">
      <div className="container-narrow">
        ...
        <form onSubmit={handleSubmit} className="space-y-10">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  rows={4}
                  placeholder={t(
                    'Klippning dam: 450 kr\nKlippning herr: 350 kr\nFärgning: från 800 kr',
                    'Women\'s haircut: 450 kr\nMen\'s haircut: 350 kr\nColoring: from 800 kr'
                  )}
                />
              </div>
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  rows={4}
                  placeholder={t(
                    'Berätta kort om ditt företag, er historia, vad ni står för...',
                    'Tell us briefly about your business, history, values...'
                  )}
                />
              </div>
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  />
                  <Label htmlFor="useStock" className="font-normal text-sm">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  rows={3}
                  placeholder={t(
                    '"Bästa frisören i stan!" - Anna K.',
                    '"Best salon in town!" - Anna K.'
                  )}
                />
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                  {[
                    ...
                    <label
                      key={page.en}
                      className="flex items-center gap-2 p-3 border border-border rounded-lg cursor-pointer hover:border-accent transition-colors has-[:checked]:border-accent has-[:checked]:bg-accent-soft"
                    >
                      <Checkbox />
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  rows={2}
                  placeholder={t(
                    'T.ex. Instagram-flöde, Google recensioner, nyhetsbrev...',
                    'E.g. Instagram feed, Google reviews, newsletter...'
                  )}
                />
              </div>
            </div>
              ...
              <label className="flex items-start gap-3 cursor-pointer">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    setConfirmations((prev) => ({ ...prev, info: checked as boolean }))
                  }
                  className="mt-0.5"
                />
                <span className="text-sm">
                  {t(
                    'Jag förstår att demon påbörjas efter att jag skickat in ALL info.',
                    'I understand the demo starts after I submit ALL info.'
                  )}
                </span>
              </label>
              <label className="flex items-start gap-3 cursor-pointer">
                <Checkbox
                  checked={confirmations.fee}
                  onCheckedChange={(checked) =>
                    setConfirmations((prev) => ({ ...prev, fee: checked as boolean }))
                  }
                  className="mt-0.5"
                />
                <span className="text-sm">
                  {t(
                    'Jag förstår att jag betalar 500 kr verifiering innan arbetet startar.',
                    'I understand I pay 500 kr verification before work starts.'
                  )}
                </span>
              </label>
              <label className="flex items-start gap-3 cursor-pointer">
                <Checkbox
                  checked={confirmations.refund}
                  onCheckedChange={(checked) =>
                    setConfirmations((prev) => ({ ...prev, refund: checked as boolean }))
                  }
                  className="mt-0.5"
                />
                <span className="text-sm">
                  {t(
                    'Jag förstår att 500 kr återbetalas om jag avvisar demon.',
                    'I understand the 500 kr is refundable if I reject the demo.'
                  )}
                </span>
              </label>
              <label className="flex items-start gap-3 cursor-pointer">
                <Checkbox
                  checked={confirmations.deduct}
                  onCheckedChange={(checked) =>
                    setConfirmations((prev) => ({ ...prev, deduct: checked as boolean }))
                  }
                  className="mt-0.5"
                />
                <span className="text-sm">
                  {t(
                    'Jag förstår att 500 kr dras av från slutpriset om jag går vidare.',
                    'I understand the 500 kr is deducted from final price if I proceed.'
                  )}
                </span>
              </label>
            </div>
          ...
          {/* Submit */}
          <div className="pt-4">
            <Button type="submit" size="lg" className="w-full sm:w-auto" disabled={!allConfirmed}>
              {t('Skicka och fortsätt till betalning', 'Submit and continue to payment')}
              <ArrowRight className="w-4 h-4" />
            </Button>
            <p className="mt-3 text-sm text-muted-foreground">
              {t(
                'Du kommer till betalningssteget efter att du skickat formuläret.',
                'You\'ll proceed to payment after submitting the form.'
              )}
            </p>
          </div>
        </form>
