...
import { Calendar, Check, Gift, LayoutDashboard } from 'lucide-react';
          ...
          <div className="grid grid-cols-2 gap-2">
            {freeFeatures.map((feature, i) => (
              <div key={i} className="flex items-center gap-2 text-sm p-2 rounded-lg bg-background/50">
                ...
                <span className="flex-1 truncate">{t(feature.label.sv, feature.label.en)}</span>
