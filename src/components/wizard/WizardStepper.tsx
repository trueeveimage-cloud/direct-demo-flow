...
import { Check, Users, Package, FileText, Clock, CreditCard } from 'lucide-react';
          ...
          return (
            <div key={s.num} className="flex items-center">
              <motion.button
                ...
                className={`flex items-center justify-center w-8 h-8 sm:w-auto sm:h-auto sm:px-4 sm:py-2 rounded-full sm:rounded-lg transition-all relative ${
                  isActive 
              ...
              >
                ...
                <span className="text-sm font-medium hidden sm:inline sm:ml-2 relative z-10">
                  {t(s.labelSv, s.labelEn)}
                </span>
              </motion.button>
              
              {index < stepInfo.length - 1 && (
                <div className="relative w-2 sm:w-8 mx-0.5 sm:mx-0">
